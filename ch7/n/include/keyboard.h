...
#define FLAG_EXT      0x0100 // normal function
#define FLAG_SHIFT_L  0x0200 // shift l
#define FLAG_SHIFT_R  0x0400 // shift r
#define FLAG_CTRL_L   0x0800 // ctrl l
#define FLAG_CTRL_R   0x1000 // ctrl r
#define FLAG_ALT_L    0x2000 // alt l
#define FLAG_ALT_R    0x4000 // alt r
...
//struct for buffer
typedef struct s_kb {
  char* p_head; //next free position
  char* p_tail; //char wait to be process
  int count;    //count of byte need to be processed
  char buf[KB_IN_BYTES]; //buffer of char
}KB_INPUT;
