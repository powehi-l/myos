...
LABEL_TSS:
    DD 0    ;link to back
    DD TopOfStack ; stack for 0 level
    DD SelectorStack ;descriptor of level 0 stack
    DD 0 ;level 1 stack
    DD 0 ;descriptor of level 1 stack
    DD 0 ;level 2 stack
    DD 0 ;GR3
    DD 0 ;EFLAGS
    DD 0 ;EAX
    ...
    DD 0 ;LDT
    DW 0 ;debuf trap
    DW $ - LABEL_TSS + 2 ;IO bitmap base address
    DB 0ffh
